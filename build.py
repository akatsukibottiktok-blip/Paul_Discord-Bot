...
""")
        ...
        cls()
        try:
            print(colored("Starting Paul...",'green'))
...
def main():
    cls()
    os.system("title Paul Mass DM Bot by RIOT Administration")
